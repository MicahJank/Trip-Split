...
const ActiveTrip = ( { activeTrip, setTrips, setActiveTrip, setCurrentTripName } ) => {
  ...
  const toggleEditInfo = () => {
    ...
    return (
      <ActiveTripContainer>
        <Feed.Event>
              <Feed.Content>
              <DeleteTripModal setCurrentTripName={setCurrentTripName} setActiveTrip={setActiveTrip} activeTrip={activeTrip} setTrips={setTrips} />
                  <Card fluid>
...
const CurrentTrip = ( { trips, setTrips, activeTrip, setActiveTrip, setCurrentTripName } ) => {
  if (activeTrip.id) {
    return <ActiveTrip setCurrentTripName={setCurrentTripName} setActiveTrip={setActiveTrip} setTrips={setTrips} activeTrip={activeTrip} />;
  } else {
